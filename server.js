...
// Startup Validation: Check if keys are loaded
if (!PAYSTACK_SECRET_KEY || PAYSTACK_SECRET_KEY.length < 10) {
    ...
    console.log("Paystack Keys Loaded Status: SUCCESS");
    console.log("Secret Key Preview:", PAYSTACK_SECRET_KEY.substring(0, 7) + "...");
}
...
// 0. CONFIG ENDPOINT
// Frontend calls this to get the public key safely
...
// HEALTH CHECK: Used by cloud providers to confirm the server is OK
...
app.listen(PORT, '0.0.0.0', () => {
    console.log(`Centuryboy's Hub Server is LIVE!`);
